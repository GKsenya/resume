      ...
      <Stack gap={isMobile ? 40 : 80} mt={{ base: 'md', sm: 'xl' }}>
        ...
        >
          ...
          >
            ...
            <Project
              name="Госуслуги"
              subtitle='Разработать приложение для предоставления государственных услуг жителям конкретного региона РФ.'
              ...
              description={(
                <Stack gap='xs'>
                  <Text fw={300}>
                    ...
                    Android-разработчик, аналитик, Product manager, тестеровщик, 2 backend-разработчика.
                  </Text>
                  <Text >Основные задачи:</Text>
                  <List>
